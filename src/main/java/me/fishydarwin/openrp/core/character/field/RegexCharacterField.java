...
public class RegexCharacterField extends ORPCharacterField {
    private String value;
    private Pattern pattern;

    public RegexCharacterField(UUID characterUUID, String name) {
    ...
    public @NotNull IORPCharacterFieldValidator createFieldValidator() {
        return new RegexCharacterFieldValidator(this, pattern);
    }

    @Override
    public void setInternalParams(@NotNull Map<String, String> params) {
        for (Map.Entry<String, String> entry : params.entrySet()) {
            if (entry.getKey().equalsIgnoreCase("regex-pattern")) {
